  ...
  <loader theme="dark" v-if="isLoad"/>
    <div class="file-block" @dragover="dragover" @dragleave="dragleave" @drop="drop">
      <input type="file" multiple name="fields[assetsFieldHandle][]" 
        class="d-none" id="assetsFieldHandle" @change="onChange" ref="file" accept=".jpg,.jpeg,.png,.svg,.gif" />
      ...
      <label for="assetsFieldHandle" class="file-block_text">
        ...
        <img class="file-block_img" src="src/assets/img/icons/download.svg" alt="">
...
export default {
  ...
  setup() {
    ...
    const [isLoad, file, handleClickUploadImage, handleChangeFile, imgLink] =
      useUploadImage("array", {
        params_form: {
          table_type: "novella",
          type_img: "novella_img",
          parent_id: route.params.novella_id,
        },
      });
